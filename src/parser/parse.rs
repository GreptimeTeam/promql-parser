    ...
    fn test_matrix_selector() {
        let cases = vec![
            ...
            (r#"test{a="b"}[5y] OFFSET 3d"#, {
                ...
                let label_matcher =
                    Matcher::new(MatchOp::Equal, String::from("a"), String::from("b"));
                Expr::new_vector_selector(Matchers::new(HashSet::from([
                    name_matcher,
                    label_matcher,
                ])))
    ...
    fn test_function_call() {
        let cases = vec![
            ...
            (r#"floor(some_metric{foo!="bar"})"#, {
                ...
                let ex = Expr::new_vector_selector(matchers).unwrap();
    ...
    fn test_subquery() {
        let cases = vec![
            (r#"foo{bar="baz"}[10m:6s]"#, {
                ...
                Expr::new_vector_selector(matchers).and_then(|ex| {
            ...
            (r#"(foo + bar{nm="val"})[5m:]"#, {
                ...
                Expr::new_binary_expr(
                    ...
                    token::T_ADD,
                    None,
                    Expr::new_vector_selector(matchers).unwrap(),
                )
            ...
            (r#"(foo + bar{nm="val"} @ 1234)[5m:] @ 1603775019"#, {
                ...
                let rhs = Expr::new_vector_selector(matchers)
